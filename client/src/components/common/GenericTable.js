          ...
          <tr>
            {columns.map((column) => (
              <th 
                key={column.field} 
                scope="col" 
                className={`px-6 py-3 text-xs font-medium text-primary-600 uppercase tracking-wider ${column.headerAlign || 'text-left'}`}
              >
                {column.header}
              </th>
            ))}
            {showActions && (
              <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-primary-600 uppercase tracking-wider">
                Azioni
              </th>
            )}
          </tr>
