      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
            <h2 className="text-lg font-semibold text-gray-700 mb-4 border-b pb-2">Informazioni Generali</h2>
            <div className="space-y-3">
              <div>
                <p className="text-sm font-medium text-gray-500">Numero Lotto</p>
                <p className="text-base">{batch.batchNumber}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Data Accettazione</p>
                <p className="text-base">{formatDate(batch.acceptanceDate)}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Numero DDT</p>
                <p className="text-base">{batch.ddtNumber}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Data DDT</p>
          ...
          <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
            <h2 className="text-lg font-semibold text-gray-700 mb-4 border-b pb-2">Dettagli Alimento</h2>
            <div className="space-y-3">
              <div>
                <p className="text-sm font-medium text-gray-500">Nome Alimento</p>
                <p className="text-base">{batch.foodDetails.foodName}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Quantità</p>
                <p className="text-base">{batch.foodDetails.quantity} {batch.foodDetails.unitOfMeasure}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Data di Scadenza</p>
                <p className="text-base">{formatDate(batch.foodDetails.expirationDate)}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500">Fornitore</p>
